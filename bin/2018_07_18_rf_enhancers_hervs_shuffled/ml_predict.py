...
def predict_model(x_train, x_test, y_train, y_test, model, results_directory="",
                  model_name="ml", cv=10):
    """
...
def predictions(model, x_train, y_train, x_test, y_test, results_directory="",
    ...
    index_list = ["actual_" + label for label in labels_list]
    columns_list = ["predicted_" + label for label in labels_list]
