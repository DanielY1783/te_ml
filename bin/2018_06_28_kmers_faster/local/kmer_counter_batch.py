...
# Counts k-mers for each herv by reading command line argument with file name with base pairs for HERVs 
...
def main():
    ...
    hervs_df = pd.read_table(DIRECTORY + "data/" + "2018_06_26_kmers_hervs_chromehmm/" +
    ...
    features_df.to_csv(DIRECTORY + "data/" + DATE + "batch_ouput/" + WRITE_FILE, 
                       sep = '\t', index = False)
